...
HD_PWD='/afs/athena.mit.edu/user/p/h/phoebepi/FFT/FFT.runs/bram_fft_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_fft.vds -m64 -mode batch -messageDb vivado.pb -notrace -source bram_fft.tcl
