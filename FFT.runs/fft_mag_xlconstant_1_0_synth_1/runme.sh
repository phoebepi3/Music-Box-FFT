...
HD_PWD='/afs/athena.mit.edu/user/p/h/phoebepi/FFT/FFT.runs/fft_mag_xlconstant_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_mag_xlconstant_1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fft_mag_xlconstant_1_0.tcl
