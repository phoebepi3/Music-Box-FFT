...
HD_PWD='/afs/athena.mit.edu/user/p/h/phoebepi/FFT/FFT.runs/xadc_demo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xadc_demo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source xadc_demo.tcl
