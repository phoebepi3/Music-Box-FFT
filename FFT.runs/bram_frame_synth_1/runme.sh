...
HD_PWD='/afs/athena.mit.edu/user/p/h/phoebepi/FFT/FFT.runs/bram_frame_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_frame.vds -m64 -mode batch -messageDb vivado.pb -notrace -source bram_frame.tcl
