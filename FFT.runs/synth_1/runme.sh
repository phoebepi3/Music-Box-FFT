...
HD_PWD='/afs/athena.mit.edu/user/p/h/phoebepi/MusicBox/Music-Box-FFT/FFT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys4_fft_demo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source nexys4_fft_demo.tcl
